...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div>
        <asp:Label ID="lblCodigoUsuarioProyecto" runat="server" Text="Codigo Usuario Proyecto" />
        ...
        <asp:Label ID="lblBuscarCodigoUsuario" Text="Buscar por codigo usuario" runat="server" />
    ...
    <div>
        ...
        <asp:GridView ID="grvListaUsuariosProyecto" runat="server" CssClass="gridview" CellPadding="10" ShowHeaderWhenEmpty="True" AutoGenerateColumns="False" OnRowDataBound="gvListaUsuariosProyecto_RowDataBound">
            <Columns>
