    ...
    protected void btnCrearProyecto_Click(object sender, EventArgs e)
    {
        ...
        if(txbCodigoProyecto.Text.Trim().Length == 4)
        {
            ...
            if (Session["EstudianteNetvalle"] != null)
            {
                ...
                {
                    cUsuario.Insertar_GUsuario_I(estudianteNetvalle.CodigoUsuarioNetvalle, estudianteNetvalle.NombresUsuarioNetvalle + " " + estudianteNetvalle.ApellidosUsuarioNetvalle ,estudianteNetvalle.SedeUsuarioNetvalle);
